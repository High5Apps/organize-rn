...
5. Create and upload the iOS archive
    ...
    4. Click **Distribute App > App Store Connect**
        - You may see "Upload Symbols Failed" warning about Hermes. This is a [known issue](https://github.com/facebook/react-native/issues/49059#issuecomment-2695136038) that is not a problem.
