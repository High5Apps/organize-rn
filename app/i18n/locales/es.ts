...
const translation: Translation = {
  action: {
    ...
    createElections: 'sCreate Elections',
    createOrg: 'Crear Org',
    decline: 'sDecline',
    discuss: 'sDiscuss',
    download: 'sDownload',
    ...
    editPermissions: 'sEdit Permissions',
    ...
    viewUnionCards: 'sView Union Cards',
    vote: 'sVote',
  },
  branding: {
    appName: 'Organize',
  ...
  explanation: {
    ...
    warning: {
      ...
      removeSelfPermission: "sIf you remove this permission from yourself, you won't be able to do it anymore.",
      viewUnionCards: {
  ...
  hint: {
    ...
    cameraRestricted: "sCamera access is restricted on your device. Unfortunately you won't be able to use Organize.",
    ...
    tapToPermitCamera: 'sTap to allow\ncamera permissions',
    tapToRevealCode: 'sTap to reveal your secret code',
    tapToShowCamera: 'sTap to show camera',
    tapToUpdateApp: 'sTap to update your app',
    unblockRemovesRow: 'sUnblocking will also remove the row from this list',
    unknownBallotType: 'sNew vote type: you must update your app to see this vote',
  ...
  question: {
    ...
    permission: {
      format: 'sWho Can {{permission}}?',
      unknown: 'sWho Can Do This?',
    },
